            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="./index.php?controller=home&action=index"><img src="./assets/img/logo.png" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <?php 
                        if($isHomePage) {
                            echo '<div class="hero__item set-bg" data-setbg="./assets/img/hero/banner2.jpg">
